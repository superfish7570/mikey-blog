...
import { PaginatedPolicies, PolicyAssignmentTargetType, PolicyStatement, Policy, CommonMessage, PaginatedPolicyAssignments } from '../../types/graphql.v2';
 ...
 *
 */
export declare class PoliciesManagementClient {
     ...
     */
    create({ code, statements, description, namespace }: {
        code: string;
     ...
     * @memberof PoliciesManagementClient
     */
    detail(code: string, namespace?: string): Promise<DeepPartial<Policy>>;
    /**
     * @name list
     * @name_zh 获取策略列表
     * @description 获取策略列表
     ...
     * @memberof PoliciesManagementClient
     */
    listAssignments({ code, namespace, page, limit }: {
        code: string;
        namespace?: string;
        page?: number;
        limit?: number;
     ...
     * @memberof PoliciesManagementClient
     */
    addAssignments(policies: string[], targetType: PolicyAssignmentTargetType, targetIdentifiers: string[], options?: {
     ...
     * @memberof PoliciesManagementClient
     */
    removeAssignments(policies: string[], targetType: PolicyAssignmentTargetType, targetIdentifiers: string[], namespace?: string): Promise<CommonMessage>;
    /**
     ...
     * @memberof PoliciesManagementClient
     */
    enableAssignment(policy: string, targetType: PolicyAssignmentTargetType, targetIdentifier: string, namespace?: string): Promise<CommonMessage>;
    /**
     ...
     * @memberof PoliciesManagementClient
     */
    disableAssignment(policy: string, targetType: PolicyAssignmentTargetType, targetIdentifier: string, namespace?: string): Promise<CommonMessage>;
}
