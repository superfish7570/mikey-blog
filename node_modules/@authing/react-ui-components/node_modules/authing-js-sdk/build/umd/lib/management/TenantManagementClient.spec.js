...
(function (factory) {
    ...
    ava_1.default('setTanentAdmin', function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, managementClient.tenant.setTanentAdmin('619c917f534a3b8ad988a209', {
                        userIds: ['11', '22']
                    })];
                case 1:
                    result = _a.sent();
    ...
    ava_1.default('updateTenantMember', function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, managementClient.tenant.updateTenantMember('619c917f534a3b8ad988a209', '111', true)];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    t.assert(result);
    ...
    ava_1.default('batchInsertResource', function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, managementClient.tenant.batchInsertResource({
                        bulk: [
                            {
                                code: '6666',
                                type: __1.ResourceType.Data,
                                description: "666",
                                actions: [
                                    {
                                        name: "action666",
...
//# sourceMappingURL=TenantManagementClient.spec.js.map