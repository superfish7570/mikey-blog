...
(function (factory) {
    ...
    var EnterpriseAuthenticationClient = /** @class */ (function () {
        ...
        EnterpriseAuthenticationClient.prototype.authorize = function (protocol, identifier, options) {
            ...
            var state = utils_2.generateUidKey(32);
            var windowRef;
            if (utils_1.isWechatBrowser()) {
                ...
                windowRef = utils_1.popupCenter('', position);
            }
            else {
            ...
            this.initProviderContext(appId).then(function (appConfig) {
                // OIDC 还要特殊初始化
                var promise = protocol === types_1.Protocol.OIDC
...
//# sourceMappingURL=EnterpriseAuthenticationClient.js.map