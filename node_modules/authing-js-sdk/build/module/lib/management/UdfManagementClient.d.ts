...
import { CommonMessage, UdfDataType, UdfTargetType, UserDefinedField, UserDefinedData } from '../../types/graphql.v2';
/**
 ...
 */
export declare class UdfManagementClient {
     ...
     */
    set(targetType: UdfTargetType, key: string, dataType: UdfDataType, label: string): Promise<UserDefinedField>;
    /**
     * @name remove
     * @name_zh 删除自定义字段
     * @description 删除自定义字段
     ...
     * @memberof UdfManagementClient
     */
    remove(targetType: UdfTargetType, key: string): Promise<CommonMessage>;
    /**
     * @name list
     * @name_zh 获取自定义字段定义
     ...
     * @memberof UdfManagementClient
     */
    list(targetType: UdfTargetType): Promise<UserDefinedField[]>;
    /**
     * @name listUdv
     ...
     * @memberof UdfManagementClient
     */
    listUdv(targetType: UdfTargetType, targetId: string): Promise<Array<UserDefinedData>>;
    /**
     * @name setUdvBatch
     * @name_zh 批量添加自定义数据
     ...
     * @memberof UdfManagementClient
     */
    setUdvBatch(targetType: UdfTargetType, targetId: string, udvList: {
        key: string;
        value: any;
