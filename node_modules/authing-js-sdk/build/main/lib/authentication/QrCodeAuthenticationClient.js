        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                ...
                genTip = function (text) {
                    ...
                    if (!needGenerate) {
                        utils_1.createCssClassStyleSheet('__authing__heading-subtitle-style', 'display: block;font-weight: 400;font-size: 15px;color: #888;line-height: 20px;margin-top: 8px;');
                ...
                genShadowMiddleStatus = function (text) {
                    ...
                    utils_1.createCssClassStyleSheet('__authing-shadow-inner-text-style-position', "font-weight: 400;font-size: 14px;line-height: 20px;color: #282D3C;;align-items: center; /*\u5782\u76F4\u5C45\u4E2D*/justify-content: center; /*\u6C34\u5E73\u5C45\u4E2D*/");
                ...
                genReferTextNode = function (text) {
                    ...
                    utils_1.createCssClassStyleSheet('__authing-shadow-inner-refer-text-style-position', "color: #215AE5;font-size: 14px;line-height:20px;font-weight: 400; text-align:center;cursor:pointer;padding-top:4px;");
                ...
                displayScannedUser = function (_) {
                    ...
                    utils_1.createCssClassStyleSheet('__authing-shadow-style-position', "text-align:center;width:" + size.width + "px;height: " + size.height + "px;background:rgba(255,255,255,.97);position: absolute;left: 50%;top: 0px;margin-left: -" + size.width /
...
//# sourceMappingURL=QrCodeAuthenticationClient.js.map